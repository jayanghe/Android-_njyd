...
public class admin extends Activity implements OnClickListener {
	...
	private void initView() {
		...
		adapter = new ArrayAdapter<News>(this, R.layout.itemview, mynews) {
			...
			public View getView(int position, View convertView, ViewGroup parent) {
				...
				View view = admin.this.getLayoutInflater().inflate(
			...
			public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
				...
				obj.deleteInBackground(new DeleteCallback() {
					...
					public void done(AVException arg0) {
						// TODO Auto-generated method stub
						if (arg0 == null) {
							Toast.makeText(admin.this, "删除成功 ", 1).show();
							update();
						}
					}
				});
	...
	public void onClick(View arg0) {
		...
		if (arg0.getId() == R.id.button1) {
			...
			update();
			Toast.makeText(admin.this, "刷新成功", Toast.LENGTH_LONG).show();
		}
	}
			...
			news.saveInBackground(new SaveCallback() {
				...
				public void done(AVException arg0) {
					...
					if (arg0 == null) {
						...
						Toast.makeText(admin.this, "发布成功", Toast.LENGTH_LONG)
								.show();
						// Toast.makeText(admin.this, "  ",
						// Toast.LENGTH_LONG).show();
					} else {
						Toast.makeText(admin.this, arg0.getMessage(),
								Toast.LENGTH_LONG).show();
					}
				}
			});
